...
The plugin text you paste here is *not* the raw PHP code but Base64-encoded text, usually preceded by header containing plugin information (such as plugin name, version and description, author name, etc).
