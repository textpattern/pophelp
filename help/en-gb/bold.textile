...
"(link-external)More information on strong and bold text in Textile":http://textpattern.com/textile-strong-and-b.

h3. HTML documentation (via MDN)

"(link-external)The @<strong>@ HTML element":https://developer.mozilla.org/en-US/docs/Web/HTML/Element/strong.

"(link-external)The @<bold>@ HTML element":https://developer.mozilla.org/en-US/docs/Web/HTML/Element/b.
