h1. What are Textpattern 'Sections'?
...
*A likely scenario for a personal site, with three sections:*
...
Note that a special hidden 'Section' always exists, named "Default". Using the 'Page' called "Default" as well as the 'Style' called "Default", this is what makes up the front page of your site.
