...
A severe vulnerability was discovered in certain versions of PHP, in the controversial legacy feature, "(link-external)registered globals":http://php.net/manual/en/security.globals.php. "(link-external)The security advisory":http://www.hardened-php.net/advisory_202005.79.html says: "can lead to unexpected behaviour of PHP applications, which can lead to execution of remote PHP code in many situations".
