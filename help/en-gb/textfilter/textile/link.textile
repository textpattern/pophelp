...
<a rel="external" target="_blank" href="http://textpattern.com/textile-link">More information on links in Textile <span class="ui-icon ui-icon-extlink">(opens an external link in a new window)</span></a>.
