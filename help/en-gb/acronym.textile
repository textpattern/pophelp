...
"(link-external)More information on abbreviations in Textile":http://textpattern.com/textile-abbr.

h3. HTML documentation (via MDN)

"(link-external)The @<abbr>@ HTML element":https://developer.mozilla.org/en-US/docs/Web/HTML/Element/abbr.

"(link-external)The @<acronym>@ HTML element":https://developer.mozilla.org/en-US/docs/Web/HTML/Element/acronym.
