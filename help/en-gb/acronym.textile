...
*Note:* In Textile versions prior to v2.5.0, the older @<acronym>@ tag is used for abbreviations. This tag has been deprecated in HTML5 in favour of the @<abbr>@ tag.

h3. Textile documentation

<a href="http://txstyle.org/doc/32/acronyms" target="_blank">More information on abbreviations in Textile</a>.
