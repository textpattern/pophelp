...
"(link-external)More information on bulleted lists in Textile":http://textpattern.com/textile-ul-list.

h3. HTML documentation (via MDN)

"(link-external)The @<ul>@ HTML element":https://developer.mozilla.org/en-US/docs/Web/HTML/Element/ul.
