...
'?=messy' mode is the most compatible - it will work without you having to do much configuration - but least beneficial in terms of readability and search engine optimisation (SEO). In this mode URLs for articles on your site would look like this:
