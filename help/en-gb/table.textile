...
<a href="http://textpattern.com/textile-table" target="_blank">More information on tables in Textile</a>.

h3. HTML documentation (via MDN)

<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/table" target="_blank">The @<table>@ HTML element</a>.

<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/tr" target="_blank">The @<tr>@ HTML element</a>.

<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/th" target="_blank">The @<th>@ HTML element</a>.

<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/td" target="_blank">The @<td>@ HTML element</a>.
