...
"(link-external)More information on citation in Textile":http://textpattern.com/textile-cite.

h3. HTML documentation (via MDN)

"(link-external)The @<cite>@ HTML element":https://developer.mozilla.org/en-US/docs/Web/HTML/Element/cite.
